...
viewLogo =
    Svg.svg
        ...
        [ Svg.path
            [ SvgAttr.fill "#666"
            , SvgAttr.class "hover:text-white"
            , SvgAttr.d "M0,9.88A21.63,21.63,0,0,1,8.33,8.39a17.78,17.78,0,0,1,5,.62l-.77,4.32a14.24,14.24,0,0,0-4.06-.57,10.67,10.67,0,0,0-3.91.57V33.89H0Z"
            ] []
        , Svg.path
